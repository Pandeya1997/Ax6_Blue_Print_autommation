...
// length
            System.out.println(shoppoing_list.size());
            List fruites = List.of("orange", " apply","watermelon","mango");
            // List can duplicate
            System.out.println(fruites);
            System.out.println(fruites.size());
//            List my_10th_marks = List.of(21,90,92,95,100);
//            System.out.println(my_10th_marks);
//            System.out.println(my_10th_marks.size());
//
//            List different_data_type = List.of("Abhishek", true, 123);
